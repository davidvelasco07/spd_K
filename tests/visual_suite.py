...
CASES = [
    ...
    ("implosion_2d", "ics", "Liska-Wendroff implosion (2D, reflective)", "inputs/implosion.athinput",
     ["time/tlim=0.5", "output/dt=0.25"], "hydro"),
    ("user_2d", "ics", "User IC hook (Gaussian pulse)", "inputs/user.athinput", [], "hydro"),
    ("sedov_2d", "ics", "Sedov blast (2D)", "inputs/sedov.athinput", [], "hydro"),
    ("spherical_blast_2d", "ics", "Spherical blast (2D)", "inputs/spherical_blast.athinput", [], "hydro"),
    ...
    ("knob_nad_delta", "knobs", "NAD: delta band", "inputs/sine_wave.athinput",
     ["mesh/nx1=16", "mesh/nx2=16", "mesh/nx3=1", "fallback/NAD=delta",
      "time/tlim=0.2", "output/dt=0.1"], "hydro"),
    ("knob_1d", "knobs", "Dimensionality: 1D", "inputs/sine_wave.athinput",
     ["mesh/nx1=32", "mesh/nx2=1", "mesh/nx3=1",
      "time/tlim=0.2", "output/dt=0.1", "job/fallback=true"], "hydro"),
    ("knob_2d", "knobs", "Dimensionality: 2D", "inputs/sine_wave.athinput",
     ["mesh/nx1=16", "mesh/nx2=16", "mesh/nx3=1",
      "time/tlim=0.2", "output/dt=0.1", "job/fallback=true"], "hydro"),
    ("knob_3d", "knobs", "Dimensionality: 3D", "inputs/sine_wave.athinput",
     ["mesh/nx1=8", "mesh/nx2=8", "mesh/nx3=8",
      "time/tlim=0.1", "output/dt=0.05", "job/fallback=true"], "hydro"),
...
CAPTIONS = {
    ...
    "implosion_2d": "Liska-Wendroff implosion with reflective walls; the low-density corner collapses along the diagonal.",
    "user_2d": "User IC hook: Gaussian density pulse advected diagonally, edited in src/user_ic.hpp.",
    "sedov_2d": "Sedov point explosion; an expanding circular blast wave forms with trouble cells on the shock front.",
    "spherical_blast_2d": "Over-pressured spherical blast expanding into ambient gas.",
    ...
    "knob_1d": "1D sine-wave advection.",
    "knob_2d": "2D sine-wave advection.",
    "knob_3d": "3D sine-wave advection (mid-z slice shown).",
